...
var discount = 0;
var pay = 0;
class EstimateReportEdit extends Component {
    ...
    componentDidMount() {
SetCurrentPage("EstimateReportEdit");
        ...
        $.ajax({
            ...
            url: " http://15.206.129.105:8080/ThroughBooksCOAPI/SalesReport/Estimateinvoicepaymentreport",
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                if (data.invoicepaymentreportlist.length != 0) {
                    ...
                    $.each(data.invoicepaymentreportlist, function (i, item) {
                        ...
                        if (item.paymentMode == "-") {
                            self.state.paymentMode1 = "Unpaid";
                            self.setState({
                                paymentMode1: self.state.paymentMode1,
                            })
                        } else {
                            self.state.paymentMode1 = item.paymentMode;
                            self.setState({
                                paymentMode1: self.state.paymentMode1,
                            })
                        }
    ...
    Submit() {
        ...
        if ((Number(this.state.pay)) != 0 && this.state.paymentMode != '') {
            ...
            $.ajax({
                ...
                url: " http://15.206.129.105:8080/ThroughBooksCOAPI/SalesReport/EstimateReportEdit",
                contentType: "application/json",
                dataType: 'json',
                async: false,
                success: function (data, textStatus, jqXHR) {
            ...
            <div class="container" style={{ height: "20px" }}>
                <div className="">
                    ...
                    <div className="inv_HeaderCls">
                        <h3>Estimate Invoice Payment</h3>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div style={{ display: "grid" }}>
                        ...
                        <div className=" est_inv_list_cls_Dwn_Btn">
                            ...
                            <div className="" data-tip data-for="downloadInvoiceTip">
                        ...
                        <div className="estimate_Order_Rw_Div">
                            <ReactTable
...
export default EstimateReportEdit;