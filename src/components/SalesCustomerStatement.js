    ...
    for (var k = 0; k < customerarray.length; k++) {
      ...
      if (temp.customerId == this.state.customerId) {
        ...
        $.ajax({
          ...
          url: " http://15.206.129.105:8080/ThroughBooksCOAPI/SalesReport/salescustomerstatementreport",
            ...
            ReactDOM.render(
              <Router>
                <div>
                  ...
                  <Route path="/" component={() => <CustomerStatement pageCalledFrom="SalesCustomerStatement" data={data} />} />
