...
class EstimateYearlyReportMonthYear extends Component {
  ...
  componentDidMount() {
    SetCurrentPage("EstimateYearlyReport");
    window.scrollTo(0, 0);
    $("#tableHeadings").hide();
    $("#totalSale").hide();
    ...
    if (this.state.fromDate.trim().length > 0 && this.state.toDate.trim().length > 0) {
      if (GivenDate > CurrentDate) {
        ...
        $.ajax({
          ...
          url: "http://15.206.129.105:8080/ThroughBooksCOAPI/EstimateReport/YearlyEstimateReport",
      ...
      confirmAlert({
        ...
        message: "Select Month And Year", // Message dialog
        confirmLabel: "Ok" // Text button confirm
      });
    }
...
<div class=" ">
              ...
              <h3 id="reportHeader" >Estimate Report  <span className="centerAlign hideContent"> for {this.state.monthName} {this.state.dispyear}</span>
              </h3>
            </div>
   ...
   {/*    <div className="row" style={{ marginTop: "13px" }}>
        ...
        <div className="col-lg-9 col-md-9 col-sm-8 col-xs-8">
          <div class="card-header">
            <h4  >Estimate Report  <span className="centerAlign hideContent"> for {this.state.monthName} {this.state.dispyear}</span> </h4>
          </div>
          <div class="card-body">
