...
import t_l1 from '../image/garagemanagementheading.png';
//import t_l1 from './tagaragelogo.png';
//css
...
import GSTQuotationList from '../GSTQuotationList';
...
export default class GenericDashboardElite extends Component {
  ...
  componentDidMount() {
    ...
    $('#sidebarCollapseone').css('display', 'none');
    ...
    $(document).ready(function () {
      ...
      $('#sidebarCollapse').on('click', function () {
        ...
        //$('#contentRender').css('margin-left','250px');
        // $('.contentRender').addClass('cont_Render');
        /* $("#sidebar").show(); */
  ...
  openNav() {
    ...
    /*  alert("hi"); */
    var sidebarCollapseone = document.getElementById("sidebarCollapseone");
    var sidebarCollapsetwo = document.getElementById("sidebarCollapsetwo");

    document.getElementById("sidebar").style["width"] = "250px";
    document.getElementById("contentRender").style["margin-left"] = "250px";
    sidebarCollapseone.style["display"] = 'none';
    sidebarCollapsetwo.style["display"] = '';
  }
  ...
  closeNav() {
    ...
    document.getElementById("contentRender").style["margin-left"] = "0px";
    sidebarCollapseone.style["display"] = '';
    sidebarCollapsetwo.style["display"] = 'none';
  ...
  GSTQuotationList() {
    ...
    ReactDOM.render(
      <Router>
        <div>
          <Route path="/" component={GSTQuotationList} />
        </div>
      </Router>,
      document.getElementById('contentRender'));
  }
  ...
  ParametersConfig() {
    ...
    ReactDOM.render(
      <Router>
        <div>
          <Route path="/" component={ParametersConfig} />
        </div>
      </Router>,
      document.getElementById('contentRender'));
  }
  ...
  CompanySetting() {
    ...
    ReactDOM.render(
      <Router>
        <div>
          <Route path="/" component={CompanySettings} />
        </div>
      </Router>,
      document.getElementById('contentRender'));
  ...
  */}
          <nav class="navbar navbar-inverse navbar_css" style={{ backgroundColor: "#05a4b5" /*backgroundColor: "#333"*/, borderColor: "#05a4b5"/*borderColor: "#333"*/ }}>
            ...
            <div className="comp_name_cent" >
              <a class="" style={{ color: "#ffffff" }} href="#"> <b>{this.state.companyName}</b></a>
            </div>
            ...
            <ul class="nav navbar-nav navbar-right pull-right " style={{ display: "flex", marginRight: "15px" }}>
              <li>
                <a href="#" class="dropdown-toggle user_profile sidemenu_autoclose_settings " data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" >
                  <span class="glyphicon glyphicon-cog " style={{ color: "#ffffff" }} ></span> &nbsp;</a>
                <ul class="dropdown-menu" style={{ marginLeft: "-110px", zIndex: "20", paddingLeft: "6px! important" }}>
                  <li><a href="#" className="user_p_menu " style={{ paddingLeft: "6px! important" }}>Emp&ensp;ID: {this.state.staffId}</a></li>
              ...
              <li><a href="#" className="user_p_menu"
                    ...
                    <span
                      ...
                      <span className="settings_Top_Submenu" style={{ paddingLeft: "10px" }}>V 1.1</span>
                    </span>
                  </a>
                  </li>
            </ul>
                  ...
                  <ul class="list-unstyled components" style={{ paddingTop: "0px", fontSize: "11px", paddingBottom: "100px" }} >
                    ...
                    <li >
                      <div>
                        ...
                        <ul class="collapse list-unstyled collapsiable" id="MasterSubmenu">
                          ...
                          <li><a className="sidemenu_autoclose" onClick={() => this.VehicleList()}><i class="fa fa-angle-right fa_submenu" style={{ border: "none", display: "inline-block", fontSize: "15px" }} aria-hidden="true"></i><span className="sbar_smenu_font">View Vehicle</span></a></li>
                          {/* <li><a className="sidemenu_autoclose" onClick={() => this.JobList()}><i class="fa fa-angle-right fa_submenu" style={{ border: "none", display: "inline-block", fontSize: "15px" }} aria-hidden="true"></i><span className="sbar_smenu_font"> Job</span></a></li> */}
                          ...
                          {/* <li><a className="sidemenu_autoclose" onClick={() => this.EnquiryFunc()}><i class="fa fa-angle-right fa_submenu" style={{ border: "none", display: "inline-block", fontSize: "15px" }} aria-hidden="true"></i><span className="sbar_smenu_font"> Enquiry</span></a></li>
                        */}
                        </ul>
                      </div>
                    ...
                    <li>
                      <a href="#SaleSubmenu" data-toggle="collapse" aria-expanded="false"
                        class="dropdown-toggle" ><i class="fa fa-dollar i_sidebar" style={{ border: "none", display: "inline-block", paddingRight: "12px", paddingLeft: "5px" }} aria-hidden="true"></i><span id="spansale" className="sidebar_Title"> &nbsp; Sale</span></a>
                      <ul class="collapse list-unstyled collapsiable" id="SaleSubmenu">
                        ...
                        <li><a className="sidemenu_autoclose" onClick={() => this.EstimateList()}><i class="fa fa-angle-right fa_submenu" style={{ border: "none", display: "inline-block", fontSize: "15px" }} aria-hidden="true"></i><span className="sbar_smenu_font"> Pro Forma Invoice</span></a></li>
 
                      </ul>
                    </li>
                    <li>
                      <a href="#InvoiceSubmenu" data-toggle="collapse" aria-expanded="false"
                        class="dropdown-toggle"><i class="fa fa-shopping-cart i_sidebar" style={{ border: "none", display: "inline-block", paddingRight: "11px" }} aria-hidden="true"></i><span id="spanpurchase" className="sidebar_Title purchase"> Purchase</span></a>
                    ...
                    {/*  <li>
                      <a href="#QuotationSubmenu" data-toggle="collapse" aria-expanded="false"
                        class="dropdown-toggle" ><i class="fa fa-print i_sidebar" style={{ border: "none", display: "inline-block" }} aria-hidden="true"></i><span id="spansale" className="sidebar_Title"> Quotation</span></a>
                      <ul class="collapse list-unstyled collapsiable" id="QuotationSubmenu">
                        <li><a className="sidemenu_autoclose" onClick={() => this.GSTQuotationList()}><i class="fa fa-angle-right fa_submenu" style={{ border: "none", display: "inline-block", fontSize: "15px" }} aria-hidden="true"></i><span className="sbar_smenu_font"> GST Quotation</span></a></li>
                        <li><a className="sidemenu_autoclose" onClick={() => this.WithoutGSTQuotationList()}><i class="fa fa-angle-right fa_submenu" style={{ border: "none", display: "inline-block", fontSize: "15px" }} aria-hidden="true"></i><span className="sbar_smenu_font"> WithoutGST Quotation</span></a></li>
                    ...
                    <li>
                      <a href="#ExpenseSubmenu"
                        class="dropdown-toggle sidemenu_autoclose" onClick={() => this.EnquiryFunc()}>
                        <i class="fa fa-commenting i_sidebar" style={{ border: "none", display: "inline-block", paddingRight: "15px" }} aria-hidden="true"></i><span id="spanexpense" className="sidebar_Title"> Enquiry</span></a>

                    </li>
                     <li>
                      <a href="#ExpenseSubmenu"
                        class="dropdown-toggle sidemenu_autoclose" onClick={() => this.BookServiceFunc()}>
                        <i class="fa fa-address-book" style={{ border: "none", display: "inline-block", paddingRight: "17px",fontSize: "18px" }} aria-hidden="true"></i><span id="spanexpense" className="sidebar_Title"> Book Service</span></a>

                    </li>

                    <li>
                      <a href="#ExpenseSubmenu"
                        class="dropdown-toggle sidemenu_autoclose" onClick={() => this.ServiceCalendarFunc()}>
                        <i class="glyphicon glyphicon-calendar" style={{ border: "none", display: "inline-block", paddingRight: "18px",fontSize: "16px" }} aria-hidden="true"></i><span id="spanexpense" className="sidebar_Title"> Service Calendar</span></a>
                    ...
                    <li>
                      <a href="#ExpenseSubmenu"
                        class="dropdown-toggle sidemenu_autoclose" onClick={() => this.BookServiceConfirmationFunc()}>
                        <i class="glyphicon glyphicon-ok" style={{ border: "none", display: "inline-block", paddingRight: "19px",fontSize: "15px"  }} aria-hidden="true"></i><span id="spanexpense" className="sidebar_Title">Service Confirmation</span></a>
  ...
  */}
                        <li><a className="sidemenu_autoclose" onClick={() => this.StaffList()}><i class="fa fa-angle-right fa_submenu" style={{ border: "none", display: "inline-block", fontSize: "15px" }} aria-hidden="true"></i><span className="sbar_smenu_font"> Employee</span></a></li>
                        ...
                        <li><a className="sidemenu_autoclose" onClick={() => this.Salary()}><i class="fa fa-angle-right fa_submenu" style={{ border: "none", display: "inline-block", fontSize: "15px" }} aria-hidden="true"></i><span className="sbar_smenu_font"> Salary</span></a></li>
                        <li><a className="sidemenu_autoclose" onClick={() => this.SalaryReport()}><i class="fa fa-angle-right fa_submenu" style={{ border: "none", display: "inline-block", fontSize: "15px" }} aria-hidden="true"></i><span className="sbar_smenu_font"> Salary Report</span></a></li>
                    ...
                    <li>
                     ...
                     {/*   <li><a className="sidemenu_autoclose" onClick={() => this.openingBalance()}><i class="fa fa-angle-right fa_submenu" style={{ border: "none", display: "inline-block", fontSize: "15px" }} aria-hidden="true"></i><span className="sbar_smenu_font"> Opening Balance</span></a></li> */}

                        {/* <li><a className="sidemenu_autoclose" onClick={() => this.ParametersConfig()}><i class="fa fa-angle-right fa_submenu" style={{ border: "none", display: "inline-block", fontSize: "15px" }} aria-hidden="true"></i><span className="sbar_smenu_font"> Parameters Config</span></a></li>
 */}
 ...
 <!-- Page Content --> */}
          ...
          <div id="contentRender" className="contentRender contentRender_sm">
            {/* 
