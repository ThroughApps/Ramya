...
class EstimateInvoiceUpdate extends Component {


constructor(data) {
super(data)

window.estimateInvoiceUpdateComponent = this;
...
this.EstimateInvoiceUpdate_CurrencyChange=EstimateInvoiceUpdate_CurrencyChange.bind(this);
...
componentDidMount() {
  ...
  SetCurrentPage("EstimateInvoiceUpdate");
...
invoiceNo:this.props.id,
tableName:"EstimateInvoiceTable",
  ...
  if(cartData.length>0){
    ...
    localStorage.setItem('CartDataInfo', CryptoJS.AES.encrypt(this.state.cartDataInfo, "shinchanbaby"));
        ...
        console.log(" BEFORE IF CALLED self.state.deletedCartData :",       self.state.deletedCartData)
                 ...
                 alert("self.state.invoiceAmt_Paid :"+self.state.invoiceAmt_Paid +" "+"invoiceAmt :"+invoiceAmt);
           ...
           /* if(this.state.paymentStatus!="UnPaid" && this.state.paymentMode==""){
              ...
              */
              ...
              $.ajax({
                ...
                url: " http://15.206.129.105:8080/ThroughBooksCOAPI/saleInvoice/UpdateEstimateInvoiceDetails",
...
export default EstimateInvoiceUpdate;



export const EstimateInvoiceUpdate_CurrencyChange = (InvoicePageStates) => {
...
console.log("InvoicePageStates :",InvoicePageStates);
 ...
 window.estimateInvoiceUpdateComponent .CurrencyFormat();
    ...
    */
    function  CloseInfo(){	
      // alert("closeinfo called ");	
       Notification.close();	
       window.estimateInvoiceUpdateComponent.NotificationClose();	
      }