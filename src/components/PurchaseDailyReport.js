...
class PurchaseDailyReport extends Component {
    ...
    componentDidMount() {
        SetCurrentPage("PurchaseDailyReport");
        ...
        $.ajax({
            ...
            url: " http://15.206.129.105:8080/ThroughBooksCOAPI/PurchaseReport/DailyPurchaseReport",
            ...
            <div class="container" >
                ...
                <div className="repot_headercls">
                    ...
                    <div class="report_card_header">
                        <h3 id="reportHeader" >Purchase Daily Report</h3>
                    </div>
                    <div class="report_reactIcon_Dcls">
                        <button type="button" id="print" class="btn btn-default " style={{marginTop:"10px"}}        onClick={() => this.printdiv()} >
