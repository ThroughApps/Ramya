...
class VehicleMakeModelValidationMessage extends Component {
...
componentDidMount() {
    ...
    SetCurrentPage("VehicleMakeModelValidationMessage");
...
export default VehicleMakeModelValidationMessage;