...
class GSTQuotationReportDisplay extends Component {
    ...
    componentDidMount() {
        SetCurrentPage("GSTquotationReportDisplay");
                ...
                $.each(data, function (i, item) {
                    ...
                    if (item.product != null) {
                        ...
                        tab += '<tr><td>' + no + '</td><td>' + item.product + '</td><td>' + Case.capital(item.productType) + '</td><td>' + item.rate + '</td><td>' + self.state.quantity + '</td>'
                            ...
                            + '<td>' + item.amount + '</td><td>' + item.serviceBy + '</td></tr>';
                    }
                })
    ...
    PrintFunc() {
        ReactDOM.render(<PrintFormat id={this.props.id} bookingId={this.props.bookingId} vehicleRegistrationNo={this.props.vehicleRegistrationNo}
            date={this.props.date} userName={this.props.userName} contact={this.props.contact}
            status={this.props.status} balanceAmt={this.props.balanceAmt} orderNumber={this.props.orderNumber} subtotal1={this.props.subtotal1} customerId={this.props.customerId} companyName={this.props.companyName} />, document.getElementById("contentRender"));
  ...
  */}
                                ...
                                <table class="table table-bordered" id="producttable">
                                    <thead id="ContentPlaceHolder1_ths" style={{ color: "black", backgroundColor: "white" }}>
                                        <tr>
                                            ...
                                            <th scope="col">Discount$</th>
                                            <th scope="col">PreFinalAmount</th>
                        ...
                        <div class="col-md-12">
                            <div style={{ borderTop: "1px solid rgba(0,0,0,.1)", borderBottom: "1px solid rgba(0,0,0,.1)", padding: "5px" }}>
                                <span ><b>Amount Chargeable In Words : </b><span id="numWords"></span> Dollar Only</span>
                            </div>
